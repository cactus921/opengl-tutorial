...
namespace test{
    ...
    */
        :   m_VertPositions     {   -1.f, -1.f, -1.f,  0.25f, 0.33f, // 0
            ...
            m_Shader("res/VertShader.shader"),
            ...
            t0 {std::chrono::system_clock::now()}
    {
        ...
        m_Shader.SetUniform4f("u_Color", 0.8, 0.2, 0.4, 1.0);
    }
    ...
    void TestVertexShader::OnUpdate(float deltaTime)
    {

    }

    void TestVertexShader::OnRender()
    {
        m_Renderer.Clear();
...

        {
            ...
            m_Shader.SetUniform1f("u_Time", dt.count());
            m_Renderer.Draw(m_VertexArray, m_IndexBuffer, m_Shader);
        }
    }

    void TestVertexShader::OnImGuiRender()
    {
    ...
    void TestVertexShader::OnDestruct()
    {
        delete this;
    }
